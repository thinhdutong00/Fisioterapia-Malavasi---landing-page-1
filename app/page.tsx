  ...
  <div className="max-w-7xl mx-auto relative z-10 w-full py-10">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        ...
        { id: 5, titolo: "Riabilitazione Neurologica", icona: <Scale size={32} />, breve: "Percorsi per il recupero funzionale in pazienti con esiti di ictus, Parkinson, sclerosi multipla o lesioni nervose.", descrizione: "Il sistema nervoso ha una straordinaria capacità di adattamento. Attraverso esercizi neurocognitivi e stimolazioni specifiche, lavoriamo per riprogrammare il movimento, migliorare l'equilibrio e contrastare la spasticità. L'obiettivo è restituirti la massima indipendenza possibile nelle attività quotidiane, con un approccio empatico e scientificamente rigoroso.", colore: "from-sky-500/20 to-transparent" },
        { id: 6, titolo: "Fisioterapia Oncologica", icona: <Home size={32} />, breve: "Supporto specialistico per la gestione del linfedema, del dolore e della stanchezza cronica (fatigue) post-oncologica.", descrizione: "La fisioterapia gioca un ruolo cruciale nel percorso di guarigione oncologica. Mi occupo del trattamento del linfedema tramite linfodrenaggio manuale e bendaggi, oltre al recupero della mobilità articolare post-chirurgia (es. mastectomia). Un supporto concreto per migliorare la qualità della tua vita, riducendo gli effetti collaterali delle terapie e restituendo energia al tuo corpo.", colore: "from-blue-400/20 to-transparent" }
      ].map((item) => (
