        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full py-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { id: 6, titolo: "Altro", icona: <Plus size={32} />, breve: "Tecnologia per la biorigenerazione.", descrizione: "Accelera i processi riparativi per infiammazioni e traumi.", colore: "from-blue-400/20 to-transparent" }
            ].map((item) => (
